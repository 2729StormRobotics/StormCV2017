#include "RetrotapeHSL.h"

namespace grip {

RetrotapeHSL::RetrotapeHSL() {
}
/**
* Runs an iteration of the pipeline and updates outputs.
*/
void RetrotapeHSL::Process(cv::Mat& source0){
	//Step HSL_Threshold0:
	//input
	cv::Mat hslThresholdInput = source0;
	double hslThresholdHue[] = {62.71186440677965, 92.2340425531915};
	double hslThresholdSaturation[] = {177.68361581920902, 255.0};
 ...
 */
cv::Mat* RetrotapeHSL::GetHslThresholdOutput(){
 ...
 */
cv::Mat* RetrotapeHSL::GetCvErodeOutput(){
 ...
 */
cv::Mat* RetrotapeHSL::GetCvDilateOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* RetrotapeHSL::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* RetrotapeHSL::GetFilterContoursOutput(){
	...
	void RetrotapeHSL::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void RetrotapeHSL::cvErode(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 * @param dst Output Image.
	 */
	void RetrotapeHSL::cvDilate(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 */
	void RetrotapeHSL::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void RetrotapeHSL::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
